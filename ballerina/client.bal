...
public isolated client class Client {
    ...
    # + headers - Headers to be sent with the request 
    # + return - OK 
    resource isolated function put api/v2/macros/[int macro_id](MacrosmacroIdBody payload, UpdateMacroHeaders headers = {}) returns InlineResponse2002|error {
        string resourcePath = string `/api/v2/macros/${getEncodedUri(macro_id)}`;
        map<string|string[]> httpHeaders = http:getHeaderMap(headers);
        http:Request request = new;
        json jsonBody = jsondata:toJson(payload);
    ...
    # + headers - Headers to be sent with the request 
    # + return - Successful response 
    resource isolated function get api/v2/workspaces/[int workspace_id](ShowWorkspaceHeaders headers = {}) returns InlineResponse201|error {
    ...
    # + headers - Headers to be sent with the request 
    # + return - OK 
    resource isolated function put api/v2/workspaces/[int workspace_id](WorkspacesworkspaceIdBody payload, UpdateWorkspaceHeaders headers = {}) returns InlineResponse201|error {
        string resourcePath = string `/api/v2/workspaces/${getEncodedUri(workspace_id)}`;
        map<string|string[]> httpHeaders = http:getHeaderMap(headers);
        http:Request request = new;
        json jsonBody = jsondata:toJson(payload);
