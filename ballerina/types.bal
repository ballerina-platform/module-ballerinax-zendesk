...
public type QueueObjectPrimaryGroups record {
    int count?;
    ListDeletedTicketsResponseActor[] groups?;
};
...
public type RequestObject record {
    ...
    MacroApplyTicketResponseResultTicketFields[] customFields?;
...
public type organizationFieldId int|string;
...
public type SLAPolicyFilterDefinitionResponseDefinitions record {
    ...
    SLAPolicyFilterDefinitionResponseDefinitionsAll[] 'any?;
};
...
public type InlineResponse2004 record {
    InlineResponse2003 definitions?;
};
...
public type SkillBasedRoutingAttributeDefinitionsDefinitions record {
    @jsondata:Name {value: "conditions_any"}
    SkillBasedRoutingAttributeDefinitionsDefinitionsConditionsAll[] conditionsAny?;
    @jsondata:Name {value: "conditions_all"}
...
public type DefinitionsResponseDefinitions record {
    @jsondata:Name {value: "conditions_any"}
    DefinitionsResponseDefinitionsConditionsAll[] conditionsAny?;
    @jsondata:Name {value: "conditions_all"}
...
public type userFieldId int|string;
